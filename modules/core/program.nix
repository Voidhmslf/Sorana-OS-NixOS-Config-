...

{
  environment.systemPackages = with pkgs; [
    ...
    playerctl # Утилита для управления плеерами и получения метаданных (нужна для Hyprlock)
    libreoffice-fresh # Современный пакет для работы с офисными документами
    qalculate-gtk # Мощный и удобный калькулятор
  ];
